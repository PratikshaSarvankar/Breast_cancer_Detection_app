...
def first_page():
    ...
    with st.container():
        ...
        # Load the image
        image_path = r"C:\Users\Pratiksha\Desktop\Breast_Cancer_Prediction_App\1stpage.jpeg"  # Ensure the path is correct
...
def second_page():
    ...
    with st.container():
        ...
        # Load the image
        image_path = r"C:\Users\Pratiksha\Desktop\Breast_Cancer_Prediction_App\2ndpage.jpg"  # Ensure the path is correct
        img = Image.open(image_path)
